...
db.define_table('question',
                ...
                Field('totratings', 'integer', readable=False, writable=False),
                Field('numlike', 'integer', readable=False, writable=False),
                Field('priority', 'decimal(6,2)', readable=False, writable=False,
                      compute=lambda r: r['urgency'] * r['importance']),
                ...
                Field('shared_editing', 'boolean', label='Shared Edit', comment='Allow anyone to edit'),
