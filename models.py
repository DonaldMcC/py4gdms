...
db.define_table('question',
                ...
                Field('startdate', 'datetime', default=(datetime.datetime.utcnow().strftime("%Y-%m-%d %H:%M")),
                      label='Date Action Starts'),
                Field('enddate', 'datetime', default=(datetime.datetime.utcnow().strftime("%Y-%m-%d %H:%M")),
