...
db.define_table('resolve',
                ...
                Field('consensus', 'decimal(4,4)', default=63,
                      requires=IS_DECIMAL_IN_RANGE(25.01, 100, error_message='Must be in range 50.01 to 100'),
                      label='Percentage Agmt required to resolve'),
                Field('Defaultresolve', 'integer', label='Default Resolution Method', default=0),
                Field('adminresolve', 'integer', label='Allow event owners to resolve', default=0),
...
db.define_table('knowledge',
                Field('source'),
                Field('title'),
                Field('related_user', label='Related User in auth table'),
                Field('defaultknowledge', 'integer', label='Default Knowledge Engine', default=0),
                format='%(title)s')
...
db.define_table('question',
                ...
                Field('factopinion', 'string', default='Opinion', requires=IS_IN_SET(['Fact', 'Opinion']),
                      label='Fact/Opinion',
                      comment='Expect answered by submitter or knowledge engines, opinion should have options'),
                ...
                Field('numanswer3', 'integer', default=0, readable=False, writable=False),
                Field('numanswer4', 'integer', default=0, readable=False, writable=False),
                ...
                Field('priority', compute=lambda r: r['urgency'] * r['importance'], readable=False, writeable=False),
                ...
                Field('shared_editing', 'integer', default=0, label='Shared Edit',
                      requires = IS_IN_SET([0,1]), comment='Allow anyone to edit'),
                Field('xpos', 'double', default=0.0, label='xcoord'),
                Field('ypos', 'double', default=0.0, label='ycoord'),
                Field('social_media', 'integer', default=0, label='Post to Twitter', requires = IS_IN_SET([0,1])),
...
db.define_table('userquestion',
                ...
                Field('reject', 'integer', default=0),
...
db.define_table('eventmap',
                ...
                Field('answer3', 'string', writable=False),
                Field('answer4', 'string', writable=False),
                ...
                Field('adminresolve', 'integer', default=0, label='True if answer or status adjusted by event owner'),
                Field('startdate', 'datetime', readable=False, writable=False, default=datetime.datetime.now),
                Field('enddate', 'datetime', readable=False, writable=False, default=datetime.datetime.now),
                Field('responsible', label='Responsible'),
