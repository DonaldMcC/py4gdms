...
class AddBasicQuestion(FunctionalTest):
    ...
    @data((USERS['USER2'], USERS['PASSWORD2'], 'User 2 Ph2 Quest', 'Yes', 'No', 'Single'),
          (USERS['USER3'], USERS['PASSWORD3'], 'User 2 Ph2 Quest', 'Yes', 'No', 'Single'),
          (USERS['USER4'], USERS['PASSWORD4'], 'User 2 Ph2 Quest', 'Yes', 'No', 'Single'),
          (USERS['USER5'], USERS['PASSWORD5'], 'User 2 Ph2 Quest', 'Yes', 'No', 'Single'))
    @unpack
