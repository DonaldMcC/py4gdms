...
# THis test will look at taking question to resolved and then challenging - so this just creates ph4 question
...
class AddBasicQuestion (FunctionalTest):
    ...
    def test_question(self):
        ...
        itemtext = "Ph4 question to resolve and unresolve"
        questiontext = WebDriverWait(self, 10).until(
            lambda self:self.browser.find_element(By.ID, 'question_questiontext'))
        ...
        if recordpos > 0:
            ...
            questiddict['ph4quest'] = recordval
